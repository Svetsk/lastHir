  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="flex justify-between flex-wrap gap-y-[100px] pt-[170px]">
        ...
        <blog-card-pac src="/blog/article/breastReduction" pod-title="Важная информация для тех" title="Моя история" sub-title="Как я пришла в хирургию" image="/image/blog/fireFive.svg" />
        <blog-card-pac src="/blog/article/breastReduction" title="Мастит" sub-title="Как лечить?" image="/image/blog/fireSix.png" />
        <blog-card-pac src="/blog/article/breastReduction" title="Рак молочной железы" sub-title="Как образуется? Как лечить?" image="/image/blog/fireSeven.png" />
      </div>
    </div>
