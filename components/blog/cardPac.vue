...
<template>
  <nuxt-link to="">
    <div class="border-[3px] border-[#fff] w-[436px] h-[440px] rounded-[40px] relative">
      <nuxt-img src="/image/blog/fireOne.png" class="absolute bottom-0 w-[432px] h-[385px] z-[-1]" />
      <div class="pt-[40px] pl-[21px]">
        ...
        <p class="bottom__title">{{ bottomTitle }}</p>
      </div>
    </div>
    <div class="flex gap-[21px] items-center p-[14px]">
      ...
      <svg class="lassr" xmlns="http://www.w3.org/2000/svg" width="23" height="28" viewBox="0 0 23 28" fill="none">
